...
from nebius.compute.v1 import image_service_pb2 as nebius_dot_compute_dot_v1_dot_image__service__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in nebius/compute/v1/image_service_pb2_grpc.py depends on'
