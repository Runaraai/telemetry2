...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in nebius/compute/v1/disk_service_pb2_grpc.py depends on'
...
def add_DiskServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Get': grpc.unary_unary_rpc_method_handler(
                    servicer.Get,
                    request_deserializer=nebius_dot_compute_dot_v1_dot_disk__service__pb2.GetDiskRequest.FromString,
                    response_serializer=nebius_dot_compute_dot_v1_dot_disk__pb2.Disk.SerializeToString,
            ),
            ...
            'List': grpc.unary_unary_rpc_method_handler(
                    servicer.List,
                    request_deserializer=nebius_dot_compute_dot_v1_dot_disk__service__pb2.ListDisksRequest.FromString,
                    response_serializer=nebius_dot_compute_dot_v1_dot_disk__service__pb2.ListDisksResponse.SerializeToString,
            ),
            'Create': grpc.unary_unary_rpc_method_handler(
                    servicer.Create,
                    request_deserializer=nebius_dot_compute_dot_v1_dot_disk__service__pb2.CreateDiskRequest.FromString,
                    response_serializer=nebius_dot_common_dot_v1_dot_operation__pb2.Operation.SerializeToString,
            ),
            'Update': grpc.unary_unary_rpc_method_handler(
                    servicer.Update,
                    request_deserializer=nebius_dot_compute_dot_v1_dot_disk__service__pb2.UpdateDiskRequest.FromString,
                    response_serializer=nebius_dot_common_dot_v1_dot_operation__pb2.Operation.SerializeToString,
            ),
            'Delete': grpc.unary_unary_rpc_method_handler(
                    servicer.Delete,
                    request_deserializer=nebius_dot_compute_dot_v1_dot_disk__service__pb2.DeleteDiskRequest.FromString,
                    response_serializer=nebius_dot_common_dot_v1_dot_operation__pb2.Operation.SerializeToString,
            ),
